...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sb', builtin.buffers, { desc = '[ ] Find [B]uffers' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'nix', 'javascript', 'css' },
  ...
  {
    -- Automatically configures indentation options for buffer based on already existing content,
    -- similar files in proj, .editorconfig...
    'tpope/vim-sleuth',
  },
